...
jQuery(document).ready(function () {
  ...
  window.setTimeout(function () {
    ...
    $("#academics").removeClass("activenavbar");
    $("#learning").removeClass("activenavbar");
    $("#school").removeClass("activenavbar");
    ...
    if ($("#tag").val() == "academics") {
      $("#academics").addClass("activenavbar");
    }
    if ($("#tag").val() == "learning") {
...
function myFunction5() {
  document.getElementById("myDropdown555").classList.toggle("show");
}
...
function myFunction6() {
  document.getElementById("myDropdown666").classList.toggle("show");
}
